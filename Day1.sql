...
-- İsmi Kemal Yasa olan satırı siliniz
...
--Soru ismi alica ve id si 123 olan kaydı siliniz
Delete from ogrenciler where isim='Ali Can' or id=123; 
-- Soru tanboldaki tum verileri silelim
...
--Personel tablosundan şirket field ini siliniz
alter table personel drop column sirket;

--Personel tablosundaki sehir sutununun adını ulke olarak degiştiriniz

alter table personel rename column sehir to ulke;

-- Personel tablosunun adını isciler olarak degisitirelim
